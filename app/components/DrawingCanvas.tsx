...
const DrawingCanvas = ({ onChange }: DrawingCanvasProps) => {
    ...
    return (
        <div className="w-full aspect-square border bg-white relative" style={{ touchAction: "none" }}>
            ...
            >
                ...
                {currentPath && <path d={currentPath} stroke="black" fill="none" strokeWidth="10" />}
            </svg>
        </div>
    );
};
