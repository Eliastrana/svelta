...
export const PROFILE_THEMES: ProfileTheme[] = [
    { id: 'svelta', label: 'Svelta', main: '#f2f1e8', soft: '#fefef8', accent: '#262626', text: '#262626' },
...
export const PROFILE_FONTS: ProfileFont[] = [
    { id: 'urbanist', label: 'Urbanist', family: 'var(--font-urbanist), sans-serif' },
    { id: 'sora', label: 'Sora', family: 'var(--font-sora), sans-serif' },
    { id: 'space-grotesk', label: 'Space Grotesk', family: 'var(--font-space-grotesk), sans-serif' },
    { id: 'fraunces', label: 'Fraunces', family: 'var(--font-fraunces), serif' },
    { id: 'newsreader', label: 'Newsreader', family: 'var(--font-newsreader), serif' },
...
export function getProfileFont(fontId?: string | null) {
    const resolvedFontId = fontId ? LEGACY_PROFILE_FONT_IDS[fontId] ?? fontId : fontId;
    return PROFILE_FONTS.find((font) => font.id === resolvedFontId) ?? PROFILE_FONTS[0];
}
